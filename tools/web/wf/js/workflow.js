...
const WF_ICONS = {
  ...
  function:   '<path d="M9 3c-2 0-3 2-3 5s1 4 3 4M15 3c2 0 3 2 3 5s-1 4-3 4M9 12h6"/>',
  // ui chrome
...
const WF_NODES = {
  ...
  tap_image:  {label:"Chạm ảnh",  ico:"target",kind:"condition",cat:"image", outs:["true","false"], fields:[{k:"template",t:"tpl"},{k:"taps",t:"select",opts:[{v:"1",t:"Chạm"},{v:"2",t:"Chạm đúp"}],d:"1"},{k:"threshold",t:"num",d:.85,step:.05},{k:"timeout",t:"num",d:10},{k:"delay",t:"num",d:0,step:.5},{k:"offsetX",lbl:"Lệch X",t:"num",d:0},{k:"offsetY",lbl:"Lệch Y",t:"num",d:0},{k:"_region",lbl:"Vùng tìm",t:"region"}], sum:p=>wfBase(p.template)+(p.taps=="2"?" ×2":"")+((p.offsetX||p.offsetY)?` +(${p.offsetX||0},${p.offsetY||0})`:"")+(p.delay?` ·chờ ${p.delay}s`:"")},
  wait_image: {label:"Chờ ảnh",   ico:"timer",kind:"condition",cat:"image",outs:["true","false"], fields:[{k:"template",t:"tpl"},{k:"threshold",t:"num",d:.85,step:.05},{k:"timeout",t:"num",d:10},{k:"delay",t:"num",d:0,step:.5},{k:"_region",lbl:"Vùng tìm",t:"region"}], sum:p=>wfBase(p.template)+(p.delay?` ·chờ ${p.delay}s`:"")},
