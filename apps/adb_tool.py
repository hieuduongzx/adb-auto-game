#!/usr/bin/env python3
"""
ADB utility CLI — list devices, connect, screenshot, etc.

Usage::

    python apps/adb_tool.py [command] [options]
"""
...
# Project root on path so ``src.*`` imports resolve when run as a script.
